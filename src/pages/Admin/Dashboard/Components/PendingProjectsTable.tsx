...
export const PendingProjectsTable = () => {
  return (
    <Card className="lg:col-span-2 border-slate-200 rounded-xl shadow-sm bg-white py-0 overflow-hidden gap-0">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 bg-slate-50/30 pt-4 pb-2">
        <div>
